...
type EvalRun = { id: string; createdAt: string; updatedAt: string; status: "running" | "paused" | "completed"; config: GenerationSettings & { topK: number; library: Library; concurrency?: number }; cases: CaseRun[]; progress: { completed: number; failed: number; total: number; percent: number } };
