...
type CaseRun = { caseId: string; filename: string; stage: string; matches?: Match[]; prompt?: string; resultFile?: string; error?: string; retryCount?: number; nextRetryAt?: string; lastTransientError?: string; remoteId?: string; remoteState?: string; timings: Record<string, number> };
